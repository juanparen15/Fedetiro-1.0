                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="toggle-switch">
                                                    <input type="checkbox" class="toggle-user-active"
                                                        data-id="{{ $data->id }}"
                                                        {{ $data->isActive ? 'checked' : '' }}
                                                        @if (auth()->user()->id == $data->id) disabled @endif>
                                                </div>
                                            </td>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            $('.toggle-switch input[type="checkbox"]').bootstrapToggle({
                on: '{{ __('SI') }}',
                off: '{{ __('NO') }}',
                size: 'small', // Ajustar el tamaño aquí
    ...
    {{-- <script>
        $(document).on('change', '.toggle-user-active', function() {
            ...
            $.ajax({
                url: "{{ route('voyager.users.toggleActive') }}",
                method: 'POST',
                data: {
                    id: userId,
                    isActive: isActive,
